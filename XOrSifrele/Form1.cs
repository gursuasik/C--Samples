...
namespace XOrSifrele
{
  ...
  private System.Windows.Forms.Button button2;
   ...
   // button2
   // 
   this.button2.Location = new System.Drawing.Point(80, 96);
  ...
  {
   int sayý, þifre, þifreli_sayý;
   try
   {
    sayý = int.Parse(textBox1.Text);
    þifre = int.Parse(textBox2.Text);
   }
   catch
   {
    MessageBox.Show("Geçerli sayý girmediniz");
    return;
   }
   þifreli_sayý = sayý ^ þifre;
   MessageBox.Show(þifreli_sayý.ToString());
  }
