...
namespace VizeFinalButunleme
{
  ...
  private System.Windows.Forms.Button button1;
   ...
   this.label3.Text = "Bütünleme Notunuz:";
   // 
   // textBox1
   // 
  ...
  private void button1_Click(object sender, System.EventArgs e)
  {
   ...
   {
    MessageBox.Show("Vize ve final için geçerli sayý girilmemiþ");
    return;
   }
   ort = v * 40 / 100 + f * 60 / 100;
   if (ort >= 49.5 && f >= 50) 
    MessageBox.Show("Geçtiniz, Ortalamanýz:" + ort.ToString());
   else
   {
    MessageBox.Show("Bütünlemeye Kaldýnýz");
    try
    {
    ...
    {
     MessageBox.Show("Bütünleme için geçerli sayý girilmemiþ");
     return;
    }
    ort = v * 40 / 100 + b * 60 / 100;
    if (ort >= 49.5 && b >= 50) 
     MessageBox.Show("Bütünlemede geçtiniz, Ortalamanýz:" + ort.ToString());
    else
     MessageBox.Show("Kaldýnýz, Ortalamanýz:" + ort.ToString());
   }
  }
