...
namespace ListView_Column
{
  ...
  private void Form1_Load(object sender, System.EventArgs e)
  {
   ...
   listView1.Columns.Add("Çalýþtýðý bölüm", -2, HorizontalAlignment.Left);
   listView1.Columns.Add("Maaþý", -2, HorizontalAlignment.Right);

   listView1.Items.Add("Ali");
   listView1.Items[0].SubItems.Add("Bilgi iþlem");
   ...
   listView1.Items[2].SubItems.Add("Bilgi iþlem");
